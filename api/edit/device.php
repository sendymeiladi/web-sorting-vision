...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (credential($db) > 0) {
        ...
        editDevice($db, $_POST['serialNumber'], $_POST['location']);
    } else {
...
function editDevice($db, $serialNumber, $location){
    $sql = "UPDATE device SET location = '$location' WHERE serial_number = '$serialNumber'";
